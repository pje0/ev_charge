  ...
  <div class="ev-container">
    <div class="ev-main-hero-content">
      ...
      <h1 class="ev-main-hero-title">
        언제 어디서나<br>
        <span class="ev-main-hero-title-accent">스마트하게</span><br>
        충전하세요
      </h1>
      <p class="ev-main-hero-desc">
        전국 EV 충전소를 실시간으로 확인하고 미리 예약하세요.
        대기 없는 스마트 충전 경험을 제공합니다.
      </p>
      <div class="ev-main-hero-btns">
        <a href="/map" class="ev-main-hero-btn-primary">📍 충전소 찾기</a>
        <a href="/reservation" class="ev-main-hero-btn-outline">📅 예약하기</a>
      </div>
    </div>
  </div>
</section>
...
<section class="ev-main-section">
  <div class="ev-container">
    <div class="ev-main-section-header">
      ...
      <p class="ev-main-section-desc">실시간 현황 조회부터 간편 예약까지, 전기차 충전의 모든 것을 한 곳에서</p>
    </div>
    <div class="ev-main-features-grid">
      <a href="/map" class="ev-main-feature-card">
        ...
        <p class="ev-main-feature-desc">카카오맵으로 주변 충전소를 한눈에 확인하고 실시간 가용 현황을 파악하세요.</p>
        <span class="ev-main-feature-link ev-main-feature-link-blue">바로가기 →</span>
      </a>
      <a href="/reservation" class="ev-main-feature-card">
        <div class="ev-main-feature-icon-wrap ev-main-feature-icon-teal">📅</div>
        <h3 class="ev-main-feature-title">간편 예약 시스템</h3>
        <p class="ev-main-feature-desc">원하는 시간대 또는 목표 충전량으로 미리 예약하고 대기 없이 충전하세요.</p>
        <span class="ev-main-feature-link ev-main-feature-link-teal">바로가기 →</span>
      </a>
      <a href="/status" class="ev-main-feature-card">
        <div class="ev-main-feature-icon-wrap ev-main-feature-icon-green">⚡</div>
        <h3 class="ev-main-feature-title">실시간 충전 현황</h3>
        <p class="ev-main-feature-desc">충전기 상태를 실시간으로 확인하고 최적 충전소를 선택하세요.</p>
        <span class="ev-main-feature-link ev-main-feature-link-green">바로가기 →</span>
      </a>
    </div>
  </div>
</section>
  ...
  <div class="ev-container">
    <div class="ev-main-cta-inner">
      ...
      <div class="ev-main-cta-content">
        ...
        <p class="ev-main-cta-desc">회원가입 후 첫 충전 50% 할인 혜택을 받으세요. 스마트한 EV 충전 라이프를 경험해보세요.</p>
  ...
  <div class="ev-container">
    <div class="ev-footer-inner">
      <div class="ev-footer-logo">
        <div class="ev-footer-logo-icon">⚡</div>
    ...
    <div class="ev-footer-copy">© 2026 EV 충전소 예약 시스템. All rights reserved.</div>
  </div>
</footer>
